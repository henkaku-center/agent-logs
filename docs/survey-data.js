  ...
  pre_course: {
    ...
    sections: [
      ...
      },
      {
        ...
        questions: [
          { id: "A1_1", text: "Code completion tools (GitHub Copilot, IDE inline suggestions) / コード補完ツール (GitHub Copilot, IDEのインライン補完)", type: "likert" },
          { id: "A1_2", text: "Conversational AI assistants (ChatGPT, Claude web) / 対話型AIアシスタント(ChatGPT, Claude web)", type: "likert" },
          { id: "A1_3", text: "AI coding assistants in command-line (Claude Code, Aider) / コマンドラインAIコーディング支援 (Claude Code, Aider)", type: "likert" },
          { id: "A1_4", text: "AI agent orchestration platforms (multi-step AI workflows) / AIエージェント連携プラットフォーム（マルチステップAIワークフロー）", type: "likert" },
          { id: "A1_5", text: "AI tools combined with version management (GitHub integration) / バージョン管理とAIツールの統合(GitHubインテグレーション)", type: "likert" },
        ],
      },
      {
        id: "A2",
        title: "Task Delegation Judgment / AI活用の適切性判断について",
        description: "For each scenario, rate how appropriate it is for AI, explain your reasoning, and choose which tool you would use. / 以下に示した架空のケースに於いて、AIに任せるのがどの程度適切かを評価し、その理由を説明したうえで、使用するツールを選択してください。",
        phase: ["pre_course", "post_course"],
        questions: [
          {
            id: "A2_1", type: "vignette",
            text: "Scenario 1: Generating REST API boilerplate for CRUD operations on a pre-existing database schema / ケース1: 既存のデータベーススキーマをもとに、CRUD操作用のREST APIのひな形を自動生成する",
          },
          {
            id: "A2_2", type: "vignette",
            text: "Scenario 2: Conducting user interviews with 3 participants about product ideas and target users / ケース2: 製品アイデアとターゲットユーザーについて3人の参加者にユーザーインタビューを実施",
          },
          {
            id: "A2_3", type: "vignette",
            text: "Scenario 3: Implementing a new feature with bugs; implementation is incomplete and error messages are unclear / ケース3：新機能の実装中で、バグがあり、実装は未完了、かつエラーメッセージも不明確な状態",
          },
          {
            id: "A2_4", type: "vignette",
            text: "Scenario 4: Pitching a project to potential investors regarding your work and presentation / ケース4: 自身のプロジェクトについて、投資家候補に向けてプレゼン（ピッチ）を行う",
          },
          {
            id: "A2_5", type: "vignette",
            text: "Scenario 5: Evaluating whether AI-generated code follows security requirements correctly / ケース5：AIが生成したコードが、セキュリティ要件を正しく満たしているかを評価する",
          },
        ],
      ...
      {
        id: "A3",
        title: "Self-Efficacy in Specifying Intent to AI / AIへの意図伝達に関する自己効力感",
        description: "Rate your agreement with each statement. / 各項目について、どの程度あてはまるかをお答えください。",
        phase: ["pre_course", "post_course"],
        ...
        questions: [
          ...
          { id: "A3_4", text: "I can adjust smaller sub-tasks and sub-questions to get better results from AI tools / AIツールでより良い結果を得るために、細かなタスクや質問を調整できる", type: "likert" },
      ...
      },
      {
        ...
        questions: [
          ...
          { id: "A4_3", text: "When AI provides a solution, I pause to check whether it addresses my real problem / AIが解決策を出したとき、それが本当に自分の問題を解決しているか、一度立ち止まって確認する", type: "likert" },
          { id: "A4_4", text: "I monitor my AI inquiry thinking process and notice gaps in my thinking / AIへの問いの立て方について、自分の思考プロセスを振り返り、考えの抜けや不足に気づく", type: "likert" },
        ],
      },
      {
        id: "A5",
        title: "Metacognitive Self-Regulation / メタ認知的自己調整 (MSLQ)",
        description: "Think about how you generally approach course work through AI support projects. Rate how much each statement applies to you. / AIを活用した課題に取り組むときの自分の進め方を思い浮かべ、以下の各項目がどの程度あてはまるか答えてください。",
        phase: ["pre_course", "post_course"],
        scale: { min: 1, max: 7, minLabel: "Never applies / 全く当てはまらない", maxLabel: "Applies all the time / 常に当てはまる" },
        questions: [
          { id: "A5_1", text: "During project work, I notice other important things that I need to accomplish / プロジェクト作業中に、達成すべき重要な点の見落としに気づくことがある", type: "likert", reverse: true },
          { id: "A5_2", text: "When taking on tasks each session, I set learning goals to guide my activities / 各回の作業に取り組むとき、進め方の指針となる学習目標を自分で決めている", type: "likert" },
          ...
          { id: "A5_8", text: "Sometimes I do things without knowing why / ときどき、なぜそうしているのか分からないまま行動してしまうことがある", type: "likert", reverse: true },
      ...
      },
      {
        ...
        questions: [
          ...
          { id: "AID1_2", text: "If 5 machines take 5 minutes to make 5 widgets, how long does it take 100 machines to make 100 widgets? / 5台の機械が5個の部品を5分で作る場合、100台の機械が100個の部品を作るのにかかる時間は？", type: "text" },
          { id: "AID1_3", text: "In a lake with lily pads that double in size daily, covering the lake in 48 days, how long to cover half? / 毎日2倍に増える睡蓮が48日で湖を覆う場合、半分を覆うのにかかる日数は？", type: "text" },
          { id: "AID1_4", text: "In a race, if you pass the person in 2nd place, what position are you in? / レースで2位の人を追い越したら、あなたの順位は？", type: "text" },
          { id: "AID1_5", text: "A farmer has 15 sheep. All but 8 die. How many remain? / 農家に15頭の羊。8頭を除いて全部死んだ。残りは何頭？", type: "text" },
          { id: "AID1_6", text: "Emily has 3 daughters. The oldest two are named April and May. What is the 3rd daughter's name? / エミリーには3人の娘。上の2人はエイプリルとメイ。3人目の名前は？", type: "text" },
          { id: "AID1_7", text: "A field is 3 feet wide and 3 feet long. How many 3-foot-wide segments fit? / 幅3フィート、長さ3フィートの畑。3フィート幅の区画はいくつ入る？", type: "text" },
        ],
      },
      {
        id: "A_ID2",
        ...
        questions: [
          ...
          { id: "AID2_17", text: "It's enough for me that something gets the job done; I don't care how or why / うまく動けばそれで十分で、どうやっているのかや、なぜそうなるのかは気にしない", type: "likert", reverse: true },
